...
const handlers: Record<string, ToolHandler> = {
  ...
  get_phase_deliverables: ({ phase }) => {
    const phaseDeliverables: Record<string, { required: string[]; optional: string[] }> = {
      ...
      ARCHITECTURE: {
        required: ["docs/bible/users/", "docs/bible/data/", "docs/bible/infra/", "packages/database/src/db/schema/"],
        optional: ["docs/bible/infra/security.md"],
      },
      DESIGN: {
        required: ["docs/bible/ui/", "packages/ui/src/components/"],
        optional: [],
      },
      PLANNING: {
      ...
      BACKEND: {
        required: ["apps/api/src/routes/", "apps/api/src/services/"],
        optional: ["apps/api/src/**/*.test.ts"],
      },
      FRONTEND: {
        required: ["apps/web/src/app/", "apps/web/src/components/"],
        optional: ["apps/web/messages/", "apps/mobile/"],
      },
      QA: {
